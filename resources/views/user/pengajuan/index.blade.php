<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                        ...
                        <tbody class="bg-white">
                            @forelse($pengajuans as $pengajuan)
                                                    <tr class="hover:bg-orange-50 transition-colors duration-200 border-b-2 border-gray-300">
                                                        ...
                                                        <!-- Judul -->
                                                        <td class="px-6 py-4 text-sm text-gray-800 font-semibold border-r-2 border-gray-300">
                                                            {{ $pengajuan->judul }}
                                                        </td>

                                                        <!-- Deskripsi -->
                                                        <td class="px-6 py-4 text-sm text-gray-700 font-medium max-w-[300px] truncate border-r-2 border-gray-300"
                                                            title="{{ $pengajuan->deskripsi }}">
                                                            {{ $pengajuan->deskripsi }}
                                                        </td>
                                                        ...
                                                        <td class="px-6 py-4 border-r-2 border-gray-300">
                                                            <span
                                                                class="px-4 py-2 rounded-full text-xs font-bold flex items-center gap-2 w-max {{
                                    ...
                                    : 'bg-yellow-100 text-yellow-800 border-2 border-yellow-300 animate-pulse')
                                                        ...
                                                        <td class="px-6 py-4">
                                                            <div class="flex items-center gap-3">
                                                                @if(Auth::user()->hasRole('admin'))
                                                                    <!-- Setujui -->
                                                                    <form action="{{ route('admin.pengajuan.setujui', $pengajuan->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <button type="submit"
                                                                    ...
                                                                    <!-- Tolak -->
                                                                    <form action="{{ route('admin.pengajuan.tolak', $pengajuan->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('PUT')
                                                                        <button type="submit"
                                ...
                                <tr class="border-b-2 border-gray-300">
                                    <td colspan="{{ Auth::user()->hasRole('admin') ? 5 : 4 }}"
                                        ...
                                        <div class="flex flex-col items-center justify-center text-gray-500">
                                            ...
                                            <p class="text-sm text-gray-400 mt-1 font-medium">Data pengajuan akan muncul di
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <!-- Menunggu -->
            <div
                class="bg-white border-2 border-yellow-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-yellow-600 text-sm font-black uppercase tracking-wide mb-1">Menunggu</p>
                        <p class="text-3xl font-black text-gray-900">{{ $stats['menunggu'] }}</p>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-black text-gray-900">{{ $stats['diterima'] }}</p>
                    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-black text-gray-900">{{ $stats['ditolak'] }}</p>
                    </div>
