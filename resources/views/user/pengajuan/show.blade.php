<x-layouts.app-layout title="Detail Pengajuan">
    <div class="max-w-5xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <!-- Main Card -->
        <div
            class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-orange-100 overflow-hidden">
            ...
            <div class="px-8 py-10 space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <!-- Nama Karyawan -->
                    <div
                        class="p-6 bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex items-center gap-4">
    ...
    ($pengajuan->status == 'ditolak' ? 'text-red-800' : 'text-amber-800')
                ...
                <!-- Detail Pengajuan -->
                <div
                    class="bg-gradient-to-br from-white to-orange-50 rounded-xl p-8 border border-orange-200 shadow-sm space-y-8">
