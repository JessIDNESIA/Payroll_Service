                ...
                <table class="w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">Bulan</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                            <td class="px-6 py-4 text-sm text-gray-900">{{ $gaji->user->name }}</td>
                            <td class="px-6 py-4 text-sm text-gray-900">{{ $gaji->bulan }}</td>
                            <td class="px-6 py-4 text-sm text-gray-900">Rp {{ number_format($gaji->total_gaji, 0, ',', '.') }}</td>
                            <td class="px-6 py-4">
                                <span class="px-3 py-1 rounded-full text-xs font-medium {{
                                    $gaji->status == 'Lunas' ? 'bg-green-100 text-green-800' : 'bg-amber-100 text-amber-800'
                                }}">
                                    {{ $gaji->status }}
                                </span>
                            </td>
